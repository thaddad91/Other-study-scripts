#####################################################
# Authors: Thierry Haddad <thierry.haddad@wur.nl>   #
#          911 031 296 110 
#          Jeroen Lodewijk <jeroen.lodewijk@wur.nl> #
#          930 203 525 030                          #
#                                   #
...
# Group 2 dendrogram + correlation
create.dendogram.plot(group.2, 
                      dataset.22, 
                      plot.title = "Group 2 dataset 22"
                      )
create.dendogram.correlation.plot(group.2, 
                                  dataset.22, 
                                  plot.title = "Group 2 dataset 22\nBased on correlation between genes"
                                  )
...
###################################################################################
# Below the various networks will be written to csv files for usage in Cytoscape  #
...
clr.ones <- which(clr.th == 1, arr.ind = T) # Return the array indices for the positions
